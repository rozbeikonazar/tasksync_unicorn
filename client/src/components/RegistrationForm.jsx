      ...
      <div className="border border-black p-5 rounded-lg">
        ...
        <form onSubmit={handleSubmit}>
          <div className="relative">
            ...
            />
            <label className="text-red-400 text-sm absolute top-0.5 left-0">
              {nameError}
            </label>
          </div>
          ...
          <button
            type="submit"
            className="text-xl py-1 px-2 rounded-lg bg-green-500 text-white mt-3"
          >
            Register
          </button>
        </form>
        {error && (
          <label className="text-red-400 text-lg text-center">{error}</label>
        )}
      </div>
    </div>
  );
